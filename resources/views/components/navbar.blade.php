<nav class="navbar default-layout-navbar navbar-color col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-color text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          <a class="navbar-brand brand-logo" href="index.html"><img src="assets/images/logo.svg" alt="logo"  style="width: 200px; height: 50px;"/></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="assets/images/logo-mini.svg" alt="logo" style="width: 200px; height: 50px;"/></a>
        </div>
